...
contract PersonalInviteManualCreationTest is Test {
    ...
    address public constant deployer = 0x6109709EcFA91A80626FF3989d68f67F5b1dd126;
    ...
    function testDeployContract() public {
        ...
        // contract will be deployed by deployer, which will have nonce 0
        ...
        vm.prank(deployer);
        new PersonalInvite(buyer, buyer, receiver, amount, price, expiration, currency, token);
        ...
        assert(len != 0);
        console.log("contract bytecode size in bytes: %s", len);
    }
}
