...
contract tokenTest is Test {
    ...
    function testSimpleAddressPrediction(bytes32 _salt) public {
        ...
        address actualAddress = tokenFactory.deploy(
            _salt,
            trustedForwarder,
            feeSettings,
            admin,
        ...
        assertEq(actualAddress, expectedAddress, "address prediction failed");
    }

    function testAddressPredictionChangesWithParameters() public {
        bytes32 salt = 0x0;
        address expectedAddress = tokenFactory.getAddress(
            salt,
            trustedForwarder,
        ...
        address otherAddress = tokenFactory.getAddress(
            bytes32("1"),
            trustedForwarder,
            feeSettings,
            admin,
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with salt");

        otherAddress = tokenFactory.getAddress(
            salt,
            address(1),
            feeSettings,
            admin,
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with forwarder");
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with feeSettings");
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with admin");
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with allowList");
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with requirements");
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with name");
        ...
        assertTrue(expectedAddress != otherAddress, "address did not change with symbol");
    }
