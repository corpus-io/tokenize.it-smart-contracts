...
contract ERC2771Helper is Test{
    ...
    */
    function registerDomain(Forwarder forwarder, string calldata domainName, string calldata version) public returns (bytes32) {
    ...
    */
    function registerRequestType(Forwarder forwarder, string calldata functionName, string calldata functionParameters) public returns (bytes32) {
    ...
    */
    function consoleLogLogs(Vm.Log[] calldata logs) public {
