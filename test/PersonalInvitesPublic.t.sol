...
import "../contracts/PersonalInvitesPublic.sol";
import "../contracts/PersonalInviteFactory.sol";
import "../contracts/FeeSettings.sol";
import "./resources/FakePaymentToken.sol";

contract PersonalInvitesPublicTest is Test {
    event Deal(
    ...
    PersonalInvitesPublic personalInvites;
    ...
    function setUp() public {
        ...
        personalInvites = new PersonalInvitesPublic(address(token), currencyReceiver, trustedForwarder);
