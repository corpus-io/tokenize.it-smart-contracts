...
import "../contracts/monerium/EUR.sol";
import "../contracts/monerium/SmartController.sol";
import "../contracts/monerium/BlacklistValidator.sol";
import "../contracts/monerium/tests/ConstantValidator.sol";
...
contract DeployEUR is Script {
    function run() public {
        ...
        console.log("Deploying smart controller");
        ...
        console.log("Deployed smart controller");

        // set controller in frontend
